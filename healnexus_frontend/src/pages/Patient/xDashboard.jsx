...
import {
    ...
    Pill, Stethoscope, FileSignature, LayoutDashboard, Eye, ExternalLink
} from 'lucide-react';
...
export default function PatientDashboard() {
    ...
    const [viewRecord, setViewRecord] = useState(null); // <-- NEW: State for Document Viewer

    const [bookingForm, setBookingForm] = useState({ doctor_id: '', date_time: '', reason: '' });
    ...
    const handleBookAppointment = async (e) => {
        ...
        try {
            ...
            setBookingForm({ doctor_id: '', date_time: '', reason: '' });
                            ...
                            <div className="space-y-6">
                                ...
                                {dashboardData.medical_records.length > 0 ? (
                                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                                        {dashboardData.medical_records.map((record, index) => (
                                            <div key={index} className="p-5 border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors flex items-center justify-between group">
                                                ...
                                                {/* THE FIX: TRIGGER THE POPUP MODAL INSTEAD OF A NEW TAB */}
                                                <button
